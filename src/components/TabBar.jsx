...
function TabBar() {
  ...
  <Stack bgcolor={"#f8f9fd"} pt={"30px"} pl={"100px"} pr={"100px"} direction="column" spacing={2} >
    ...
    <Stack justifyContent="space-between" direction="row" spacing={2} >
      ...
      >
        <Tab sx={{color:'black' ,fontSize:'16px', fontWeight:'700' ,fontFamily:'Poppins'}} label="All Submissions" />
        <Tab sx={{color:'black' ,fontSize:'16px', fontWeight:'700' ,fontFamily:'Poppins'}} label="Favourites Submissions" />
      </Tabs>
