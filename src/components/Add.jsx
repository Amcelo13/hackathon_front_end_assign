    ...
    function Add({toEdit}) {
        ...
        const uploadButtonContent = selectedImage?( 
            <Stack width={"100%"} padding="0px 15px" alignItems="center" direction="row" justifyContent={"space-between"}>
                <Stack direction="row" spacing={2} alignItems="center">
                    <img style={selectedImageStyle} src={selectedImage.url}/>
                    <Typography sx={{ lineHeight: 1 }}> {selectedImage.name} </Typography>
                </Stack>
                <Stack direction="row" spacing={2}>
                    <CloudUploadIcon/>
                    <Typography sx={{ lineHeight: 1 }}> Reupload </Typography>
                </Stack>
            </Stack> 
        ): (
            <Typography sx={{ lineHeight: 1 }}> Click to upload image here </Typography>
        )
        ...
        return (
            <Stack>
                ...
                <Container sx={{ bgcolor: "#f8f9fd" }} maxWidth="xl" style={{ width: "100vw", paddingLeft: 0, paddingRight: 0 }}>
                    ...
                    <Stack width={"800px"} spacing={3} p={"50px"} ml={"50px"} mt={"5px"} direction="column" bgcolor={"#fff"}>
                        <Typography variant="h1" sx={{ color: 'black', marginBottom: '1rem', fontFamily: 'Poppins', fontSize: 30 }}>New Hackathon Submission</Typography>
                        <Stack bgcolor={"#fff"} spacing={1}>
                            <Typography sx={{ lineHeight: 1.2 }}> Title </Typography>  
                        ...
                        <Stack bgcolor={"#fff"} spacing={1}>
                            <Typography sx={{ lineHeight: 1.2 }}> Summary </Typography>  
                        ...
                        <Stack bgcolor={"#fff"} spacing={1}>
                            <Typography sx={{ lineHeight: 1.2 }}> Description </Typography>  
                        ...
                        <Stack bgcolor={"#fff"} spacing={1}>
                            <Typography sx={{ lineHeight: 1.2 }}> Cover Image </Typography>  
                        ...
                        <Stack bgcolor={"#fff"} spacing={1} direction="row" justifyContent={"space-between"}>
                            <Stack bgcolor={"#fff"} spacing={1} >
                                <Typography sx={{ lineHeight: 1.2 }}> Hackathon Start Date </Typography>  
                            ...
                            <Stack bgcolor={"#fff"} spacing={1} >
                                <Typography sx={{ lineHeight: 1.2 }}> Hackathon End Date </Typography>  
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <DatePicker sx={{ marginTop: '1rem' }}
                                        value={enddatevalue}
                        ...
                        <Stack bgcolor={"#fff"} spacing={1}>
                            <Typography sx={{ lineHeight: 1.2 }}> Github Repository </Typography>  
                        ...
                        <Stack bgcolor={"#fff"} spacing={1}>
                            <Typography sx={{ lineHeight: 1.2 }}> Other Links </Typography>  
